...
## command parameters
spec <- matrix(
  c("rawf",    "R", 1, "character", "[Required] Raw file after merging two populations",
    "idAf",    "A", 1, "character", "[Required] ID file of population A with only 1 column",
    "idBf",    "B", 1, "character", "[Required] ID file of population B with only 1 column",
    "phef",    "P", 1, "character", "[Optional] If columns 1 and 2 in G matrix are row/column index, the ID in the phenotype file is renumbered",
    "method",  "M", 1, "character", "[Optional] Method of calculating G matrix/[Yvonne(default)/No/Chen/Mean]",
    "workdir", "D", 1, "character", "[Optional] working directory",
    "out",     "O", 1, "character", "[Optional] output file name(Can include path)",
